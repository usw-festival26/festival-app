...
export function StageVisualization() {
  return (
    <View className="flex-1 bg-festival-primary-light items-center justify-center">
      ...
      <AppText className="text-xl font-black text-festival-primary-dark absolute">무대</AppText>
    </View>
  );
}
